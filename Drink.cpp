...
Drink::Drink(string _name, float _price, STYLE _style) : name(_name),
base_price(_price), style(_style) {}
...
float Drink::TotalPrice()
{
    ...
    case TALL:
        ...
        break;
    default:
        return 0.0; // quiet compiler warning by adding a default case, which 
...
void Drink::Print() {
    ...
    cout << left << setw(22) << name_str << "$" << fixed << setprecision(2) <<
        setw(4) << TotalPrice() << endl;
}
